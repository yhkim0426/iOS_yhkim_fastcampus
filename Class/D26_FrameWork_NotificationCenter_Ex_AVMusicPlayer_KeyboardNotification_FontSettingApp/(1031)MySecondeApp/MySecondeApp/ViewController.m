...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(audioPlayerDidInterrupted:) name:AVAudioSessionInterruptionNotification object:nil];
}

- (void)audioPlayerDidInterrupted:(NSNotification *)noti {
    NSLog(@"___ interrupted");
}
